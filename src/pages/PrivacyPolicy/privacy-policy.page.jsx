...
import FormattedTextbox from "../../components/FormattedTextbox/formatted-textbox.component";
...
const PrivacyPolicy = () => {
  return (
    <div className="page privacy-policy">
      <Container>
        <FormattedTextbox title="Privacy Policy">
          <h2>
            <p>Your privacy is important to you and to us</p>
          </h2>
          <p>
            This privacy policy ("Policy") describes how the personally
            identifiable information ("Personal Information") you may provide on
            the thejavalounge.com website ("Website" or "Service") and any of
            ...
            the Java Lounge, LLC ("the Java Lounge, LLC", "we", "us" or "our").
            ...
            of this Agreement. This Policy does not apply to the practices of
          ...
          <p>
            ...
            Services. This statistical information is not otherwise aggregated
          ...
          <p>
            ...
            knowingly provide to us when you create an account, make a purchase,
            or fill any online forms on the Website. When required, this
          ...
          <p>
            - Deliver products or services- Improve products and services- Send
          ...
          <p>
            - Deliver targeted advertising- Enforce terms and conditions and
            policies
          </p>
          <p>
            - Run and operate the Website and Services. Processing your Personal
            Information depends on how you interact with the Website and
            Services, where you are located in the world and if one of the
          ...
          <p>
            ...
            Where necessary for processing future payments and subject to your
            prior consent, your financial information will be stored in
            encrypted form on secure servers of our reputed payment gateway
            service provider who is beholden to treating your Personal
            Information in accordance with this Policy. All direct payment
            gateways adhere to the latest security standards as managed by the
            ...
            the Website and Services are also in compliance with PCI
            vulnerability standards in order to create as secure of an
            environment as possible for Users. Scans for malware are performed
            on a regular basis for additional security and protection.
          </p>
          <p>
          ...
          <p>
            ...
            settings page of your account on the Website or simply by contacting
            us.
          </p>
          <p>
          ...
          <p>
            ...
            its assets, your user account, and Personal Information will likely
          ...
          <p>
            Any requests to exercise your rights can be directed to the Java
            Lounge, LLC through the contact details provided in this document.
            Please note that we may ask you to verify your identity before
            responding to such requests. Your request must provide sufficient
            ...
            person. You must include sufficient details to allow us to properly
          ...
          <p>
            ...
            and Services without their permission. If you have reason to believe
            that a child under the age of 18 has provided Personal Information
            to us through the Website and Services, please contact us. You must
          ...
          <p>
            ...
            that issued the cookie to you. We may use cookies to collect, store,
            and track information for statistical purposes to operate the
            ...
            prefer. To learn more about cookies and how to manage them, visit
            internetcookies.org
          </p>
          <p>
          ...
          <p>
            This document was last updated on February 1, 2021 <em>*</em>
          </p>
        </FormattedTextbox>
      </Container>
    </div>
